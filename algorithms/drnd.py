...
class DRND_Algorithm(nn.Module):
    ...
    def define_policy(self):
        ...
        self.policy = DRND_Learner(
            ...
            drnd_lr=getattr(self.args, "drnd_lr", 3e-4),
            ...
            int_reward_scaler=getattr(self.args, "int_reward_scaler", 1.0),
            ext_reward_scaler=getattr(self.args, "ext_reward_scaler", 2.0),
            pos_idx=pos_idx,
            goal_idx=goal_idx,
            device=self.args.device,
        )
