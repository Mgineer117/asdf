...
nohup python3 main.py --project ablation_irpo --env-name fourrooms-v2 --algo-name irpo --num-runs 10 --aggregation-method argmax --noise-std 0.0 --gpu-idx 2 &  # argmax
nohup python3 main.py --project ablation_irpo --env-name fourrooms-v2 --algo-name irpo --num-runs 10 --aggregation-method argmax --noise-std 0.3 --gpu-idx 2 &  # argmax
nohup python3 main.py --project ablation_irpo --env-name fourrooms-v2 --algo-name irpo --num-runs 10 --aggregation-method argmax --noise-std 0.5 --gpu-idx 2 &  # argmax
nohup python3 main.py --project ablation_irpo --env-name fourrooms-v2 --algo-name irpo --num-runs 10 --aggregation-method argmax --noise-std 1.0 --gpu-idx 2 &  # argmax